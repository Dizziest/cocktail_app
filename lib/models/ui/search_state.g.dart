...
class _$SearchState extends SearchState {
  ...
  @override
  final BuiltList<CocktailItem> searchResults;
  @override
  final String error;
...
class SearchStateBuilder implements Builder<SearchState, SearchStateBuilder> {
  ...
  ListBuilder<CocktailItem> _searchResults;
  ListBuilder<CocktailItem> get searchResults =>
      _$this._searchResults ??= new ListBuilder<CocktailItem>();
  set searchResults(ListBuilder<CocktailItem> searchResults) =>
